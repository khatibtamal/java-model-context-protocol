...
public class StdioTransport {
    ...
    public static void main(String[] args) {
         ...
         */
        McpSyncServer mcpSyncServer = McpServer.sync(stdioTransport)
        ...
        mcpServerConfig.addTools(mcpSyncServer);
        mcpServerConfig.addPrompts(mcpSyncServer);
        mcpServerConfig.addResources(mcpSyncServer);
    }
}
